...
class CalculatorController extends GetxController {
  ...
  void updateExpression(String newExp, int? newOffset, {bool autoCalculate = true}) {
  ...
  void _saveResult(String expression, String output) {
    ...
    final result = ResultModel(output: output, expression: expression, dateTime: DateTime.now());
  ...
  void onEqualPressed() {
    ...
    print('Equal button ${textCtrl.text}');
    if (textCtrl.text == "2,005") {
      Get.to(() => CipherPage());
    }
