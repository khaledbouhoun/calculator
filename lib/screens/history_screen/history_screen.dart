...
import 'package:h_k_app/widgets/wipe_overlay_widget.dart';
                            ...
                            child: SizedBox(
                              ...
                              child: ClipRect(
                                child: ListTile(
                                  ...
                                  title: const Text('Press and hold to copy result'),
                                  tileColor: theme.colorScheme.secondary.withValues(alpha: 0.1),
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      settingsCtrl.updateSettings(
                                        settingsCtrl.state?.copyWith(showHistoryTip: false) ?? SettingsModel.normal(),
                                      );
                                    },
                                  ),
                                ),
                            ...
                            (historyList) => ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  onTap: () {
                                    CalculatorController.instance.updateExpression(history.expression, -1);
                                    DashboardController.instance.animateToPage(1);
                                  },
                                  onLongPress: () async {
                                    await Clipboard.setData(ClipboardData(text: history.output.formatThousands()));
                                    HapticFeedback.heavyImpact();
                                  },
                                );
                              },
                            ),
                            onEmpty: Center(child: Text('Expression history = 0', style: textStyle)),
                            onLoading: const Center(child: CircularProgressIndicator()),
                            onError: (error) => Center(child: Text(error ?? ' ', style: textStyle)),
                          ),
                        ),
                      ],
                    ),
