              ...
              builder: (context, controller) {
                return const Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('and change theme, button style and more', style: TextStyle(color: Colors.white, fontSize: 18)),
                  ],
                );
              },
            ),
      ...
      children: [
        ...
        IgnorePointer(
          ...
          child: AnimatedOpacity(
            ...
            child: Material(
              color: isDark ? Colors.transparent : Colors.grey.withValues(alpha: 0.5),
              child: Align(
          ...
          child: AnimatedOpacity(
            ...
            child: Material(
              ...
              child: Align(
                ...
                child: Lottie.asset(AppConst.swipeLeftGesture, key: historyKey, height: 150, width: 150, controller: _swipeLeftController),
              ),
            ),
          ),
        ),
