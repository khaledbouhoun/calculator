...
enum Fonts {
  ...
  Future<String> license() async {
    switch (this) {
      ...
      case Fonts.cabin:
      case Fonts.pacifico:
        return await rootBundle.loadString('assets/google_fonts/OFL-${name.toLowerCase().removeSpaces}.txt');
  ...
  ThemeData setToTheme(ThemeData theme) {
    switch (this) {
      case Fonts.rubik:
        return theme.copyWith(textTheme: GoogleFonts.rubikTextTheme());
      case Fonts.roboto:
        return theme.copyWith(textTheme: GoogleFonts.robotoTextTheme());
      case Fonts.montserrat:
        return theme.copyWith(textTheme: GoogleFonts.montserratTextTheme());
      case Fonts.arsenal:
        return theme.copyWith(textTheme: GoogleFonts.arsenalTextTheme());
      case Fonts.merriweather:
        return theme.copyWith(textTheme: GoogleFonts.merriweatherTextTheme());

      case Fonts.ptSans:
        return theme.copyWith(textTheme: GoogleFonts.ptSansTextTheme());
      case Fonts.margarine:
        return theme.copyWith(textTheme: GoogleFonts.margarineTextTheme());
      case Fonts.dancingScript:
        return theme.copyWith(textTheme: GoogleFonts.dancingScriptTextTheme());

      case Fonts.kodeMono:
        return theme.copyWith(textTheme: GoogleFonts.kodeMonoTextTheme());

      case Fonts.cabin:
        return theme.copyWith(textTheme: GoogleFonts.cabinTextTheme());
      case Fonts.pacifico:
        return theme.copyWith(textTheme: GoogleFonts.pacificoTextTheme());
    }
  }
}
