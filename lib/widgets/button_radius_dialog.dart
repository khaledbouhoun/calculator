...
class _ButtonRadiusDialogState extends State<ButtonRadiusDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final contentTextStyle = theme.textTheme.bodyMedium?.copyWith(color: isDark ? Colors.white : Colors.black);
    return AlertDialog(
      ...
      actions: [
        ...
        TextButton(onPressed: () => Navigator.of(context).pop(12.0), child: const Text('Reset to default')),
        TextButton(
          onPressed: () => Navigator.of(context).pop(buttonRadius == widget.buttonRadius ? null : buttonRadius),
