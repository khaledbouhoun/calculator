...
import 'package:h_k_app/widgets/confirm_dialog.dart';
import 'package:h_k_app/widgets/icon_page_indicator.dart';
import 'package:h_k_app/widgets/info_dialog.dart';
        ...
        children: [
          GetBuilder<SettingsController>(
            builder: (ctrl) {
              return IconPageIndicator(
                ...
                icons: [LucideIcons.wrench, LucideIcons.calculator, LucideIcons.history],
          ...
          AnimatedSwitcher(
            ...
            child: IconButton(
              ...
              icon: onHistoryPage ? const Icon(LucideIcons.trash2, color: Colors.red) : const Icon(LucideIcons.info),
                      ...
                      ConfirmDialog(
                        title: Row(
                          ...
                          children: [
                            ...
                            Lottie.asset(!isDark ? AppConst.deleteDark : AppConst.deleteLight, height: 50, width: 50, repeat: false),
                          ],
                        ),
