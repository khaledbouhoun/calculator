...
class _NeumorphicButtonState extends State<NeumorphicButton> {
  ...
  List<BoxShadow>? _buildShadows(bool isDark) {
    ...
    return widget.boxShadow ??
        [
          BoxShadow(color: isDark ? const Color(0xff313D4E) : const Color(0xffEBEFFF), offset: const Offset(5, 5), blurRadius: 10),
          BoxShadow(color: isDark ? const Color(0xff394656) : const Color(0xffFFFFFF), offset: const Offset(-5, -5), blurRadius: 10),
        ];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        width: widget.width,
        constraints: widget.constraints ?? const BoxConstraints(minHeight: 55, maxHeight: 75, minWidth: 55, maxWidth: 75),
