...
import 'package:h_k_app/calculator_icons.dart';
import 'package:h_k_app/utils/enum.dart';
import 'package:h_k_app/widgets/neumorphic_button.dart';
import 'package:h_k_app/widgets/stacked_button.dart';
import 'package:lucide_icons_flutter/lucide_icons.dart';

class NumberPad extends StatelessWidget {
  const NumberPad({super.key, this.onNumberPressed, this.onOperationPressed, required this.borderRadius});
  ...
  Widget build(BuildContext context) {
    ...
    final numberStyle = TextStyle(color: theme.iconTheme.color, fontSize: numbersSize, fontWeight: FontWeight.bold);
    final operationStyle = TextStyle(color: primaryColor, fontSize: operationSize, fontWeight: FontWeight.w900);
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              buildTextBtn(CalculatorButton.allClear.value, () => onOperationPressed?.call(CalculatorButton.allClear), operationStyle),
              SizedBox(
                width: 75,
                child: StackedButton(
                  borderRadius: borderRadius,
